...
{
    public partial class Repertoire : System.Web.UI.Page
    {
        ...
        private class FilmItem {
            ...
            public FilmItem(int idfilm, string tytul, string gatunek)
            {
                this.IdFilm = idfilm;
                this.Tytul = tytul;
                this.Kategoria = gatunek;
                this.Seanse = new List<SeansItem>();
                String[] tyt = tytul.Split(null);
                this.ImageUrl = "~\\Images\\" + tyt[0] + ".jpg";
            }
        ...
        private void RepGen(DateTime day)
        {
            ...
            using (var db = new CinemaEntities())
            {
                ...
                var query_film = (from f in db.film
                             ...
                             where s.data == day
                             orderby f.id_film
                             select new { f.id_film, f.tytul, f.gatunek }
                            ).Distinct();
                ...
                {
                    filmy.Add(new FilmItem(qf.id_film, qf.tytul, qf.gatunek));
